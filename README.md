### Função JavaScript pode alterar o conteúdo HTML, só é executado quando chamado
...
### Quando o botão Try it for clicado, aí sim a função é chamada! E o parágrafo é alterado
